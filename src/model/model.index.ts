...
// auto
export {AutoModel}  from "./auto/auto";
...
// media
export {MediaModel}  from "./media/media";

// taller

export {TallerModel}  from "./taller/taller";

// user
export {UserModel}  from "./user/user";

// tranlate
export {TranslateModel}  from "./translate/translate";
